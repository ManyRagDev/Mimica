...
export const CATEGORIES: Record<CategoryKey, { label: string; color: string; icon: string }> = {
  acoes: { label: 'Ações', color: '#3B82F6', icon: 'flash' },
  'cultura-pop': { label: 'Cultura Pop', color: '#EC4899', icon: 'film-outline' },
  lugares: { label: 'Lugares', color: '#10B981', icon: 'location-outline' },
  objetos: { label: 'Objetos', color: '#F59E0B', icon: 'cube-outline' },
  abstratos: { label: 'Abstrato', color: '#8B5CF6', icon: 'sparkles-outline' },
};
