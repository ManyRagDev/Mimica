...
function findWorkspaceRoot(startDir) {
  ...
  // Fallback to startDir's parent folder if not found
...
function getDeploymentDomain() {
  ...
  console.warn(
    'WARNING: No deployment domain found. Skipping mobile Metro bundle compilation as it is not needed for the web preview.',
  );
  process.exit(0);
}
